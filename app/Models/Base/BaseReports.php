...
class BaseReports extends Model
{
    ...
    protected $fillable = ['day', 'staking_amount', 'withdraw_amount', 'exchange_airdrop_amount', 'deposit_staking_amount', 'staking_reward_loyalty_amount', 'income_amount', 'actual_income_amount', 'withdrawable_amount', 'user_register_count', 'user_login_count', 'trail_count', 'staking_count', 'withdraw_count', 'exchange_airdrop_count', 'deposit_staking_count', 'staking_reward_loyalty_count', 'income_count', 'actual_income_count', 'withdrawable_count','parent_id'];
