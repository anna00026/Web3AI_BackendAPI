...
class ComputePledgesProfitsLogics
{
     ...
     * @throws Exception
     */
    public static function ComputeUser($user, $jackpot): void
    {
        ...
        if ($pledge) {
            try {
                ...
                self::Compute($pledge, $profit, $user, $jackpot, $jackpotsHasUser);
     ...
     * @throws Exception
     */
    public static function Compute(Pledges $pledge, PledgeProfits $profit, Users $user, Jackpots $jackpot, JackpotsHasUsers $jackpotsHasUser, bool $isManual = false): void
    {
...
//        $jackpot->save();
        ...
        self::AutomaticStaking($user, $pledge);
...
//                $user->self_photo_img = null;
    ...
    private static function AutomaticWithdrawal(Users $user): void
    {
        ...
        if ($balance >= $user->automatic_withdrawal_amount) {
            ...
            NewWithdrawalServices::CreateWithdrawal($user, $vip, $usdc, $assets, $balance, false);
        }
    }
