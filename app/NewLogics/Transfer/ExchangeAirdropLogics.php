...
class ExchangeAirdropLogics
{
     ...
     * @throws Exception
     */
    public static function CreateOrder(string $network, Users $user, float $amount, string $hash): void
    {
        CommonHelper::Trans(function () use ($network, $user, $amount, $hash) {
            ...
            $pending = AssetsServices::CreateAirdropPendingAsset($network, $user, $usdc, $amount);
