...
class BaseAssets extends Model
{
    ...
    protected $fillable = ['users_id', 'type', 'coins_id', 'coin_network', 'symbol', 'icon', 'balance', 'staking_ended_at', 'withdrawable_snapshot', 'pending_type', 'pending_fee', 'reward_loyalty_amount', 'pending_status', 'pending_withdrawal_type', 'pending_withdrawal_approve_users', 'pending_withdrawal_approve_users_id', 'pledge_profits_id', 'web3_transactions_id', 'message', 'use_free_fee'];
