...
use App\Enums\Users2faStatusEnum;
...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('default_network', 10)->default(Web3NetworkEnum::Ethereum->value);
            ...
            $table->myEnum('id_front_img_status', UsersIdentityStatusEnum::class, 'id front img status', null, true);
            $table->string('id_reverse_img')->nullable();
            $table->myEnum('id_reverse_img_status', UsersIdentityStatusEnum::class, 'id reverse img status', null, true);
            $table->string('self_photo_img')->nullable();
            $table->myEnum('self_photo_img_status', UsersIdentityStatusEnum::class, 'self photo img status', null, true);
...
//            $table->amount('current_today_loyalty_value'); // 跑任务：compute pledge
            ...
            $table->myEnum('enable2fa', UsersStatusEnum::class, '2fa', Users2faStatusEnum::Enable->name);
            ...
            $table->ipAddress('ip')->nullable();    // 注册时的ip
            $table->foreignId('agent_users_id')->comment('代理id，ref[Users]')->nullable(); // 最近的一级代理，每天更新一下
