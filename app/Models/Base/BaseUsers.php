 ...
 * @property string $default_network
 ...
 * @property string $id_front_img_status
 * @property string $id_reverse_img
 * @property string $id_reverse_img_status
 * @property string $self_photo_img
 * @property string $self_photo_img_status
