...
Route::prefix('/agent')->name('agent.')->group(function ($router) {
    ...
    Route::middleware('auth:sanctum')->group(function ($router) {
        ...
        RouteHelper::New($router, Agent\VipsController::class);
        RouteHelper::New($router, Agent\JackpotsController::class);
        RouteHelper::New($router, Agent\PledgeProfitsController::class);
        RouteHelper::New($router, Agent\BonusController::class);
