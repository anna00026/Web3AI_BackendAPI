...
//            ->where('pending_type', AssetsPendingTypeEnum::Staking->name)
     ...
     * @return Assets
     */
    public static function CreateAirdropPendingAsset(string $network, Users $user, Coins $usdc, float $amount): Assets
    {
...
//                'web3_transactions_id' => '', #
     ...
     * @return Assets
     */
    public static function CreateDepositPendingAssets(string $network, Users $user, Coins $usdc, PledgeProfits $profit): Assets
    {
        return Assets::create([
            'users_id' => $user->id, #
            'type' => AssetsTypeEnum::Pending->name, # 类别:Staking,WithdrawAble,Pending,Airdrop
...
//            'web3_transactions_id' => $web3->id, #
     ...
     * @return Assets
     */
    public static function CreateByStakingRewardLoyalty(string $network, Users $user, Coins $usdc, int $amount, int $reward): Assets
    {
        return Assets::create([
            'users_id' => $user->id, #
            'type' => AssetsTypeEnum::Pending->name, # 类别:Staking,WithdrawAble,Pending,Airdrop
