...
class DepositPledgeProfitLogics
{
     ...
     * @throws Err
     */
    public static function SubmitDeposit(string $network, PledgeProfits $profit, Users $user, ?string $hash = null): void
    {
        ...
        try {
            ...
            if ($amounts['need_staking_amount'] === 0) {
                ...
                $pending = AssetsServices::CreateDepositPendingAssets($network, $user, $usdc, $profit);
                // create web3
                $web3 = Web3TransactionsServices::CreateByDeposit($user, $usdc, $pending, $hash);
                // update pending
     ...
     * @throws Err
     */
    public static function DepositWeb3Callback(Web3Transactions $web3, TxModel $hashData): void
    {
        try {
            DB::beginTransaction();
