...
class SettingsServices
{
     ...
     * @throws Exception
     */
    public static function Set(string $network, Users $user, Vips $vip, ?Pledges $pledge, array $params): void
    {
        $key = $params['key'];
        $value = $params['value'];
        ...
        switch ($key) {
            ...
            case 'can_trail_bonus':
                ...
                StartPledgesLogics::StartTrail($user);
                break;
            ...
            case 'can_automatic_staking':
                if ($value) {
                    ...
                    if ($staking_type == PledgeProfitsStakingTypeEnum::FullPosition->name) {
                        ...
                        AutomaticStakingApproveLogics::Create($network, $user, $hash);
                    }
